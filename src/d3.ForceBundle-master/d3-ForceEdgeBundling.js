...
export var ForceEdgeBundling = function () {
    ...
    function project_point_on_line(p, Q) {
        ...
        var r =
            ((Q.source.y - p.y) * (Q.source.y - Q.target.y) - (Q.source.x - p.x) * (Q.target.x - Q.source.x)) / (L * L);
    ...
    function scale_compatibility(P, Q) {
        ...
        return (
            2.0 / (lavg / Math.min(edge_length(P), edge_length(Q)) + Math.max(edge_length(P), edge_length(Q)) / lavg)
        );
    }
    ...
    function forcebundle() {
        ...
        // console.error('subdivision_points_for_edge', subdivision_points_for_edge);
    ...
    forcebundle.nodes = function (nl) {
        ...
        // console.error('forcebundle', forcebundle);
        return forcebundle;
    };
